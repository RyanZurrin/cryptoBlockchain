# -*- coding: utf-8 -*-
"""
Created on Fri Jan 21 02:30:10 2022
...
class Blockchain:
    ...
    # replaces the chain with the longest chain if needed
...
# all methods below use the GET and POST protocol to communicate with the node from within postman
# Mining a new block using postman to call the method
